...
<body class="font-sans bg-gray-100">
    ...
    <div class="px-4 py-8 mx-auto max-w-7xl">
        <a href="{{ route('home') }}" class="inline-block px-4 py-2 mb-6 text-sm font-semibold text-white rounded-md bg-emerald-600 hover:bg-emerald-700">
            Kembali ke Home
        </a>
            ...
            @foreach($users as $user)
                <div class="p-4 transition duration-300 bg-white shadow-lg rounded-2xl hover:shadow-xl">
                    <div class="flex items-center gap-4 mb-4">
                        <img src="{{ asset('storage/' . $user->avatar_url ?? 'images/avatar.png') }}" alt="Avatar" class="w-16 h-16 border border-gray-200 rounded-full">
                        <div>
