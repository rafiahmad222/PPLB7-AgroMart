        ...
        <div class="flex flex-col gap-8 lg:flex-row">
            ...
            <div class="w-full lg:w-2/3 animate-fade-in">
                <div class="p-8 bg-white shadow-md rounded-xl">
                    ...
                    <form id="transactionForm" action="{{ route('transaksi-layanan.store') }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            <!-- Layanan -->
                            <div class="md:col-span-2">
                                <label for="layanan_id" class="block mb-2 text-sm font-medium text-gray-700">Pilih
                                    Layanan</label>
                                <div class="relative">
                                    <select id="layanan_id" name="layanan_id"
                                        class="block w-full px-4 py-3 pr-10 text-base border-gray-300 rounded-lg shadow-sm focus:ring-emerald-500 focus:border-emerald-500 input-transition"
                                        required>
                            ...
                            <!-- Alamat -->
                            <div class="md:col-span-2">
                                <label for="alamat_id" class="block mb-2 text-sm font-medium text-gray-700">Alamat
                                    Layanan</label>
                                <div class="relative">
                                    <select id="alamat_id" name="alamat_id"
                                        class="block w-full px-4 py-3 pr-10 text-base border-gray-300 rounded-lg shadow-sm focus:ring-emerald-500 focus:border-emerald-500 input-transition"
                                        required>
                                ...
                                <div class="mt-2">
                                    <a href="#" class="text-sm text-emerald-600 hover:text-emerald-800">+ Tambah
                                        Alamat Baru</a>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="relative flex items-center">
                                    <button type="button" id="decrementJumlah"
                                        class="flex items-center justify-center w-10 h-10 text-gray-600 bg-gray-100 rounded-l-lg hover:bg-gray-200">
                                    ...
                                    <input type="number" id="jumlah" name="jumlah" min="1" value="1"
                                        class="block w-full h-10 px-4 py-2 text-center border-gray-300 input-transition"
                                        required>
                                    <button type="button" id="incrementJumlah"
                                        class="flex items-center justify-center w-10 h-10 text-gray-600 bg-gray-100 rounded-r-lg hover:bg-gray-200">
                            ...
                            <!-- Jadwal Booking -->
                            <div>
                                <label for="jadwal_booking"
                                    class="block mb-2 text-sm font-medium text-gray-700">Jadwal Booking</label>
                                <input type="datetime-local" id="jadwal_booking" name="jadwal_booking"
                                    class="block w-full px-4 py-3 border-gray-300 rounded-lg shadow-sm date-input focus:ring-emerald-500 focus:border-emerald-500 input-transition"
                                    required>
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                                    <div>
                                        <input type="radio" id="transfer" name="pembayaran" value="Transfer"
                                            class="hidden peer" checked>
                                        <label for="transfer"
                                            class="flex items-center justify-between w-full p-4 text-gray-700 transition-all bg-white border-2 border-gray-200 rounded-lg cursor-pointer peer-checked:border-emerald-500 peer-checked:bg-emerald-50 hover:border-emerald-300">
                                            <div class="flex items-center">
                                                <svg class="w-6 h-6 mr-3 text-emerald-500" fill="none"
                                            ...
                                            <svg class="hidden w-5 h-5 text-emerald-500 peer-checked:block"
                            ...
                            <div id="bukti_transfer_div" class="md:col-span-2 payment-method-transfer">
                                ...
                                <div class="flex items-center justify-center w-full">
                                    <label for="bukti_transfer"
                                        class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer hover:border-emerald-500">
                                        <div id="upload_placeholder"
                                            ...
                                            <p class="mb-1 text-sm text-gray-500"><span class="font-semibold">Klik
                                        ...
                                        <div id="preview_container" class="hidden w-full h-full">
                                            <img id="preview_image" class="object-contain w-full h-full"
                                                src="#" alt="Bukti Transfer">
                                        </div>
                        ...
                        <div class="mt-8">
                            <button type="submit"
                                class="w-full px-6 py-3 text-base font-medium text-white transition-all rounded-lg shadow-md bg-emerald-600 hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2">
                ...
                <div class="sticky p-6 bg-white shadow-md rounded-xl top-10">
                    ...
                    <div class="p-4 mt-6 rounded-lg bg-gray-50">
                        <div class="flex items-start">
                            <svg class="flex-shrink-0 w-5 h-5 mt-0.5 text-emerald-500" fill="currentColor"
                                viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
                            ...
                            <p class="ml-3 text-xs text-gray-600">
                                Pastikan jadwal layanan yang dipilih tersedia. Tim kami akan menghubungi Anda untuk
                                konfirmasi.
                            </p>
                        </div>
                    </div>
